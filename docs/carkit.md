...
2. Once your order has been accepted, follow this [Guidance](images\CarKeyProvisioningForm-v3.pdf)
...
The Hourfleet car kit connects to the internet via a cellular connection. This is currently facilitated by an external modem, something our engineers are trying to improve on. You will need to organize a cellular data SIM from your preferred mobile carrier. The connection should be on a **monthly account** (ie NOT pre-paid / topup), and have **>1Gb of monthly data included**. You will need a [standard size SIM](https://thefutureofthings.com/12104-what-are-different-sim-sizes). This SIM is inserted in to the cellular model with the gold contacts downwards, and the cut-off corner facing outwards.  
